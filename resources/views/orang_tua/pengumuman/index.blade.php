...
@section('content')
    ...
    <div class="space-y-4">
        @forelse($pengumuman as $item)
            <article class="rounded-[22px] border border-[var(--portal-line)] bg-white p-[24px] shadow-[0_14px_32px_rgba(41,60,89,0.07)] max-[700px]:p-4">
        ...
        @empty
            <div class="rounded-[22px] border border-[var(--portal-line)] bg-white p-[24px] text-center text-[#5e7084] shadow-[0_14px_32px_rgba(41,60,89,0.07)]">
